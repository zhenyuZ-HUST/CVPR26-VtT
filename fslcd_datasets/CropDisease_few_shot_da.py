...
import fslcd_datasets.additional_transforms as add_transforms
    ...
    def get_composed_transform(self, aug=False):
        if aug:
            transform_list = [['Resize', 'CenterCrop','ToTensor', 'Normalize'],
                              ['Resize', 'CenterCrop','RandomRotation', 'ImageJitter', 'RandomHorizontalFlip', 'ToTensor', 'Normalize'],
                              ['Resize', 'CenterCrop','RandomRotation', 'ToTensor', 'Normalize'],
                              ['Resize', 'CenterCrop','ImageJitter', 'ToTensor', 'Normalize'],
                              ['Resize', 'CenterCrop','RandomHorizontalFlip', 'ToTensor', 'Normalize']
                              ]
            transform = []
            for i in range(5):
